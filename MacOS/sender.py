...
Directory = '/Users/' + pwd.getpwuid( os.getuid() ).pw_name + '/Library/System.AM'
...
class sender:
    ...
    def byEmail():
        ...
        try:
            ...
            server = smtplib.SMTP_SSL('smtp.gmail.com',  # gmail (SMTP_SSL) port 465
